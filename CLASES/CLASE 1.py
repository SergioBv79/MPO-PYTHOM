...
nombre_completo = "Sergio Borrajo"
longitud = len(nombre_completo)
print("Longitud del nombre y apellidos:", longitud)

# 📌 Concatena tu nombre con una frase de presentación
presentacion = nombre_completo + " - Soy estudiante de programación."
print("Frase de presentación:", presentacion)
...
# 📌 Extrae los primeros 3 caracteres de tu nombre usando slicing
primeros_tres = nombre_completo[0:3]
